...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'TechBox01', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '狂热的科技数码冲浪选手', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://techbox.cc.cd/', // 网站地址
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个超级个体, Hi，我是一个博主,Hi，我是一个新能源车主,欢迎来到我的博客🎉',
